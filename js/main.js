$(document).ready(function (e) {
    ...
    var n = document.querySelector(".country_action").innerHTML,
        ...
        (e.managerDialog = [
            {
                text: "Hello!<br>Saya Sifu Master The Golden Dragon King, seorang pembaca fizik dan ahli nujum",
            },
            {
                text: "Apakah jantina anda?",
                m: {text: "Lelaki"}, w: {text: "Perempuan"}
            },
            {
                text: "Bilakah anda dilahirkan?"
            },
        ]),
        (e.userZodiak = [
            {
                /* <p class='hidden-zodie' style='display: none'>{zodie}</p> ở sau dòng dưới. */
                text: "Terima kasih. Menurut astrologi, tanda anda adalah - <p style='color: #3fc726'>{zodie}</p>. <p class='hidden-zodie' style='display: none'>{zodie}</p>"
            }
        ]),
        (e.managerVariants = {
            w: [
                [
                    [
                        {text: "Anda seorang yang sangat adil, sentiasa melihat perkara dari kedua-dua belah pihak, anda tidak bercakap dan membenci yang rumit.</br>"},
                        {text: "Laluan kerjaya anda selalunya penuh dengan kesukaran. Kebanyakan orang menentang anda, ia adalah kerana kuasa gelap menghalang anda supaya hidup anda tidak berjalan lancar. Jangan terlepas apa-apa, saya akan membantu anda menangani perkara buruk yang menghalang anda."},
                        {text: '<br><img width="400px" src="img/2.jpeg"></br>'},
                        {text: 'Segala-galanya tentang anda menunjukkan bahawa anda dilahirkan untuk bahagia, bahawa anda lebih bertuah daripada kebanyakan orang, dan bahawa pilihan anda sentiasa betul dan berpandangan jauh. Saya akan membantu anda mencari nombor muktamad yang akan mengubah hidup anda.'},
                        {text: "Untuk mengetahui nasib masa depan anda, putar roda astrologi, ia akan memberitahu anda apa yang akan berlaku kepada anda dalam masa terdekat, anda akan mengelakkan nasib malang jika anda memutar roda astrologi ini."},
                    ],
                    [
                        {text: " "},
                    ],
        ...
        (e.socNumber = [{
            text: "Sila klik butang di bawah"
        },]),
        (e.Forms = function (t) {
            e.FormsParams = {
                method: "POST",
